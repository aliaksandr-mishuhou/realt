...
using Realt.Parser.Onliner.Dto;

namespace Realt.Parser.Onliner
{
    public class OnlinerParser : IParserV1, IParserV2
    {
        ...
        private readonly ILogger<OnlinerParser> _logger;

        public int Source => SourceId;

        public OnlinerParser(ILogger<OnlinerParser> logger)
        {
            _logger = logger;
        }
